<x-app-layout title="Home">
    ...
    <main>
        <!-- Find a car form -->
        <x-search-from action="/search" method="GET" />
        <!--/ Find a car form -->
        ...
        <section>
            <div class="container">
                ...
                <div class="car-items-listing">
                    @for ($i = 0; $i < 15; $i++)                    
                        <x-car-item-card 
                            carViewHref="/view/{{$i + 1}}" 
                            carImageSrc="/img/cars/Lexus-RX200t-2016/1.jpeg" 
                            carAddress="New Jersey"
                            carItemTitle="2016 - Lexus RX200t"
                            carItemPriceCurrency="$"
                            carItemPrice="25,000"
                            :carAdditionalInfo="['Suv', 'Electric']"
                        />
                    @endfor
                </div>
            </div>
